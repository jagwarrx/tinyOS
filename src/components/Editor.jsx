...
const initialConfig = {
  ...
  theme: {
      ...
      paragraph: 'mb-2',
      code: 'bg-bg-tertiary text-fg-primary p-4 rounded-lg font-mono text-sm my-4 overflow-x-auto border border-border-primary',
      codeHighlight: {
        atrule: 'text-syntax-purple',
        attr: 'text-syntax-blue',
        boolean: 'text-syntax-orange',
        builtin: 'text-syntax-blue',
        cdata: 'text-syntax-grey',
        char: 'text-syntax-green',
        class: 'text-syntax-yellow',
        'class-name': 'text-syntax-yellow',
        comment: 'text-syntax-grey italic',
        constant: 'text-syntax-orange',
        deleted: 'text-syntax-red',
        doctype: 'text-syntax-grey',
        entity: 'text-syntax-orange',
        function: 'text-syntax-blue',
        important: 'text-syntax-red font-bold',
        inserted: 'text-syntax-green',
        keyword: 'text-syntax-purple',
        namespace: 'text-syntax-blue',
        number: 'text-syntax-orange',
        operator: 'text-fg-primary',
        prolog: 'text-syntax-grey',
        property: 'text-syntax-blue',
        punctuation: 'text-fg-secondary',
        regex: 'text-syntax-green',
        selector: 'text-syntax-green',
        string: 'text-syntax-green',
        symbol: 'text-syntax-orange',
        tag: 'text-syntax-red',
        url: 'text-syntax-blue underline',
        variable: 'text-syntax-orange',
      },
    },
  onError: (error) => {
    console.error(error)
